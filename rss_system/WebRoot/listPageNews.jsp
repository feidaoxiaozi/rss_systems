      ...
      <div class="row-fluid">
        <div class="span2">
          <div class="well sidebar-nav">
            ...
            <s:a href="startRole.action" role="button" class="btn" data-toggle="modal">启动任务</s:a>
...
　　　　</s:if>
　　　　<s:else>
　　　　　　  <a href="findNewsByTitle.action?page=1">第一页</a>
　　　　　　<a href="findNewsByTitle.action?page=<s:property value="%{rssNews.currentPage-1}"/>">上一页</a>
　　　　</s:else>
　　　　<s:if test="%{rssNews.currentPage != rssNews.totalPage}">
　　　　　　<a href="findNewsByTitle.action?page=<s:property value="%{rssNews.currentPage+1}"/>">下一页</a>
　　　　　　<a href="findNewsByTitle.action?page=<s:property value="rssNews.totalPage"/>">最后一页</a>
　　　　</s:if>
     <s:else>
　　　　　　下一页 最后一页
　　　　</s:else>
...
<!-- Modal -->
<div id="myModal" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true" align="right">
